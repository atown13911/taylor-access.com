    ...
    <div class="oauth-page">
      <div class="oauth-card">
        <div class="oauth-header">
          <img class="oauth-logo" src="assets/brand/taylor-access-intelligence.png" alt="Taylor Access" />
  ...
  styles: [`
    .oauth-page {
      ...
      background-image:
        ...
        url('/assets/access-world-backdrop-v2.png');
