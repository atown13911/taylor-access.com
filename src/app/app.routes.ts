...
export const routes: Routes = [
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'recruiting/bls',
        loadComponent: () => import('./features/recruiting/bls/bls.component').then(m => m.BlsComponent)
      },
      {
        path: 'applicants',
        loadComponent: () => import('./features/hr/applicants/applicants.component').then(m => m.ApplicantsComponent)
      ...
      },
      {
        path: 'inventory',
        loadComponent: () =>
          import('./features/system/inventory/inventory.component').then((m) => m.InventoryComponent),
      },
      {
        path: 'drivers',
      ...
      {
        path: 'admin/reports',
        loadComponent: () => import('./features/admin-security/reports/reports.component').then(m => m.ReportsComponent)
      },
      {
        path: 'admin/apps',
