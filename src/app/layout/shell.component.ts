  ...
  navSections: NavSection[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'MOTIV', icon: 'bx bxs-truck', route: '/motiv' },
      ]
    },
    {
      label: 'HR',
      items: [
        ...
        { label: 'Accountability', icon: 'bx bx-sitemap', route: '/hr/accountability' },
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Reports', icon: 'bx bx-bar-chart-alt-2', route: '/admin/reports' },
  ...
  private restoreSavedStyles(): void {
    ...
    setTimeout(() => {
      ...
      if (bg.startsWith('solid-')) {
        ...
        const bgUrl = bg === 'tss-portal' ? '/assets/tss-backdrop.png' : '/assets/access-world-backdrop-v2.png';
