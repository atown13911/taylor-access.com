"""Probe: check if drive.readonly is authorized in domain-wide delegation.

Run: railway run python scripts/probe_drive_scope.py
Only performs a token exchange — no reads/writes. Never prints key material.
"""
import base64
import json
import os
