        ...
        try
        {
            ...
            var employees = pagedUsers.Select(u =>
            {
                ...
                return new
                {
                    ...
                    Laptop = u.Laptop, IssuedPhone = u.IssuedPhone, AccessBadge = u.AccessBadge,
                    Headset = u.Headset, Monitor = u.Monitor, KeysFob = u.KeysFob,
                    EquipmentNotes = u.EquipmentNotes,
