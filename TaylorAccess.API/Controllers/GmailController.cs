...
public class GmailController : ControllerBase
{
    ...
    public GmailController(LocalIntegrationStatusService statusService, CurrentUserService currentUserService)
    {
    ...
    public async Task<ActionResult<object>> GetStatus(CancellationToken cancellationToken)
    {
        ...
        var status = await _statusService.GetGoogleStatusAsync(orgId ?? user.OrganizationId, cancellationToken);
        return Ok(new
        {
